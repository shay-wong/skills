...
For the broader routing decision of when a capability should be a rule, a skill, MCP, or a plain CLI/API workflow, see [capability-surface-selection.md](./references/capability-surface-selection.md).
