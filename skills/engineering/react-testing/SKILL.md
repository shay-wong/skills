...
- Core React testing rules: use the installed `react-patterns` Skill
- Skills: [react-patterns](../react-patterns/SKILL.md), [accessibility](../accessibility/SKILL.md), [e2e-testing](../e2e-testing/SKILL.md), plus the installed `tdd` Skill
