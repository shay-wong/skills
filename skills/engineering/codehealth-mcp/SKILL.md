...
- Pair with `verification-loop`, `tdd`, or `/quality-gate` as a structural check (not a replacement for tests/lint)
...
| `tdd` | Tests pass ≠ healthy design — check score after refactors |
