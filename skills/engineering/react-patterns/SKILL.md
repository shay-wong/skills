...
See [hooks.md](./references/rules/hooks.md) for the full ruleset. Highlights:
...
- Rules: [references/rules/](./references/rules/) for coding style, hooks, patterns, security, and testing
