...
> This file contains the React-specific pattern layer. Use the installed `coding-standards` Skill for the shared baseline. For hook-specific rules see [hooks.md](./hooks.md).
