...
> This file contains React-specific testing guidance. Use the installed `tdd` Skill for the shared testing baseline.
...
For those, use Playwright Component Testing or end-to-end Playwright/Cypress runs. Use the installed `e2e-testing` Skill for that workflow.
