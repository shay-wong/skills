---
name: wizard
description: Generate an interactive bash wizard for steps only a human can perform, such as dashboards, credentials, secrets, migrations, or cutovers. Skip tasks the agent can execute directly.
---
