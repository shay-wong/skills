...
description: Write and validate repository-local Agent Notes for non-trivial decisions, recording rationale, alternatives, consequences, and lifecycle. Use when a change or decision will likely need future explanation.
metadata:
  origin: czm15053/write-notes-like-deepseek
---
