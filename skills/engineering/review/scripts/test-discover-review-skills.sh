...
mkdir -p \
  ...
  "$fixture/skills/gh-address-comments" \
  "$fixture/skills/golang-patterns" \
  "$fixture/skills/flutter-add-widget-preview" \
  "$fixture/skills/tdd" \
  "$fixture/cache/ponytail/ponytail/9.9.9/skills/ponytail-audit" \
...
printf '%s\n' '---' 'name: gh-address-comments' '---' > "$fixture/skills/gh-address-comments/SKILL.md"
printf '%s\n' '---' 'name: golang-patterns' '---' > "$fixture/skills/golang-patterns/SKILL.md"
printf '%s\n' '---' 'name: flutter-add-widget-preview' '---' > "$fixture/skills/flutter-add-widget-preview/SKILL.md"
printf '%s\n' '---' 'name: tdd' '---' > "$fixture/skills/tdd/SKILL.md"
printf '%s\n' '---' 'name: ponytail-audit' '---' > "$fixture/cache/ponytail/ponytail/9.9.9/skills/ponytail-audit/SKILL.md"
